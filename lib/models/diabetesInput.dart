class DiabetesInputModel {
  ...
  DiabetesInputModel({
    ...
    this.fastingBloodSugar = 0.0,
    this.hbA1c = 0.0,
    this.serumCreatinine = 0.0,
    this.bunLevels = 0.0,
    this.cholesterolTotal = 0.0,
    this.cholesterolLDL = 0.0,
    this.cholesterolHDL = 0.0,
    this.cholesterolTriglycerides = 0.0,
